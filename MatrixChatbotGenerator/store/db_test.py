...
# Question 1
python_question1 = create_question("python_question1", python_quiz, "Which of the following is a valid variable name "
                                                                    "in Python?")
...
create_feedback("python_feedback11", python_question1, "Correct", "Correct! 'variable1' is a valid variable name in "
                                                                  "Python.")
...
# Question 2
python_question2 = create_question("python_question2", python_quiz, "Which keyword is used to define a function in "
                                                                    "Python?")
...
create_feedback("python_feedback31", python_question3, "Correct", "Correct! '#' is used to start a comment in Python.")
...
create_feedback("python_feedback41", python_question4, "Correct", "Correct! 'x = 5' creates a variable with the "
                                                                  "numeric value 5.")
create_feedback("python_feedback42", python_question4, "InCorrect", "Incorrect. 'x = 5' is the correct way to create "
